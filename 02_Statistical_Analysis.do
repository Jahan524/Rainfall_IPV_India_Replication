...
* Purpose: Execute GLMM, GSEM, and Robustness Checks
********************************************************************************
** 1. MAIN ANALYSIS: MIXED EFFECTS LOGISTIC REGRESSION (GLMM) 
* Baseline models for all violence types
...
** Heterogeneity Analysis based on different precipitation zone
...
** MECHANISM TESTING: PATH ANALYSIS (GSEM)
* Backlash Mechanism
gsem ///
...
* Indirect effects of calculation
...
gsem ///
   ...
   (anyviolence <- drinkalcohl z_wealth c.rainvar##i.informal i.age i.maryears ///
       ...
       family(bernoulli) link(logit))
* Indirect effect of calculation
...
* Trimmed Values (1st to 99th percentile)
preserve
sum rainvar, detail
